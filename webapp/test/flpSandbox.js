		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comvesizfapctaskmgmt-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comvesizfapctaskmgmt-display": {
								"semanticObject": "comvesizfapctaskmgmt",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.my.zfapctaskmgmt",
									"url": sap.ui.require.toUrl("com/my/zfapctaskmgmt")
								}
							}
						}
					}
